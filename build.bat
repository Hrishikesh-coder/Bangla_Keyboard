...
set CORE_SRCS=src\core\BanglaText.cpp src\core\Morphology.cpp src\core\NgramModel.cpp src\core\UserDictionary.cpp src\core\CandidateResolver.cpp src\core\ContextAnalyzer.cpp src\core\ExceptionDictionary.cpp src\core\FixedLayoutEngine.cpp src\core\InputBuffer.cpp src\core\PhoneticEngine.cpp src\core\SpecialCharPicker.cpp src\core\SuggestionPolicy.cpp src\core\SymbolTable.cpp src\core\TokenContext.cpp src\core\Tokenizer.cpp src\core\TokenTrie.cpp src\core\UnicodeComposer.cpp src\core\WordDictionary.cpp
